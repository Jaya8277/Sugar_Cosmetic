        ...
        <div>
            ...
            <div className="sublogin">
                ...
                <div className="loginbox">
                    ...
                    <div className="otpsection">
                        ...
                        <div className="otpbox">
                            <input type="text" className="enterotp enterotp1" maxlength="1" />
                            <input type="text" className="enterotp enterotp2" maxlength="1" />
                            <input type="text" className="enterotp enterotp3" maxlength="1" />
                            <input type="text" className="enterotp enterotp4" maxlength="1" />
                            <div>
                ...
                <div className="logcontent">
                    ...
                    <div className="smll">
                        <small className="smll">By Signing up or logging in, you agree to our Terms and Conditions</small>
                    </div>
