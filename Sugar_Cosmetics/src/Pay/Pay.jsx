        ...
        <div className='sure'>
            ...
            <div className="cartPriceOffer">
                <div className="payContainer">
                    ...
                    <div className="priceDetailTag"><img src="https://in.sugarcosmetics.com/desc-images/Offers_price_details.svg" alt="" /> Payment Method</div>
                    ...
                    <div>
                        <div className="upi">
                            ...
                            <div className="iconfles">
                                ...
                                <img src="https://in.sugarcosmetics.com/desc-images/Check.svg" alt="" className="uiconleft" />
                            </div>
                        </div>
                        <div className="paydrop">
                            <div className="payinput"><input type="text" placeholder="Enter UPI Id" /></div>
                        </div>
                    </div>
                    <div>
                        <div className="mobwallet">
                            ...
                            <div className="iconfles">
                                <p>Mobile Wallets</p>
                                <img src="https://in.sugarcosmetics.com/desc-images/Check.svg" alt="" className="miconleft" />
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className="debitcard">
                            ...
                            <div className="iconfles">
                                ...
                                <img src="https://in.sugarcosmetics.com/desc-images/Check.svg" alt="" className="diconleft" />
                            </div>
                        </div>
                    ...
                    <div className="netbanking">
                        ...
                        <div className="iconfles">
                            <p>Net Banking</p>
                            <img src="https://in.sugarcosmetics.com/desc-images/Check.svg" alt="" className="niconleft" />
                        </div>
                    </div>
                    <div >
                        <div className="cash">
                            ...
                            <div className="iconfles">
                                ...
                                <img src="https://in.sugarcosmetics.com/desc-images/Check.svg" alt="" className="ciconleft" />
                            </div>
                        </div>
                    ...
                    <div className="button_delivery_shopping">
                        <div className="continueShopping_btn"><a href="../HTML/index.html">delivery Info</a></div>
